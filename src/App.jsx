...
const initialTask = [
	{id: 1, title: 'Задача 1', status: 'done', description: 'Начать новый проект', priority: 1},
	{id: 2, title: 'Задача 2', status: 'progress', description: 'Продумать логику доски задач', priority: 3},
	{id: 3, title: 'Задача 3', status: 'todo', description: 'Написать приложение с использованием React', priority: 1},
	{id: 4, title: 'Задача 4', status: 'review', description: 'Добавить стили и сделать красоту', priority: 4}
]
